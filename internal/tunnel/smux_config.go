...
// With 64MB stream buffer and 256ms RTT, theoretical max is ~2 Gbps.
func DefaultSmuxConfig() *SmuxConfig {
	return &SmuxConfig{
		...
		MaxReceiveBuffer:  512 * 1024 * 1024,  // 512MB session buffer
		MaxStreamBuffer:   64 * 1024 * 1024,   // 64MB stream buffer
	}
}
